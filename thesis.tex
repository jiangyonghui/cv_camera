...
\newcommand{\myname}{Yonghui Jiang}
\newcommand{\mytitle}{A Real-time ROS Pipeline for Human Action Detection and Recognition}

\newcommand{\reviewerone}{Prof. Dr.-Ing. Christoph Stiller}
\newcommand{\advisor}{Jie Yu, Dipl.-Computermath.}

\newcommand{\timeandplace}{Karlsruhe, October 2018}
...
%% graphics
	\usepackage{wrapfig}
	\usepackage{graphicx, subfigure} % Required for the inclusion of image
...
\frontmatter
\graphicspath{{Graphics/Logos/}{Graphics/Figures/}}
...
\include{Main/2_Technical_Background}	
\include{Main/3_Related_Work}
\include{Main/4_Pipeline_Design}
\include{Main/5_Experiments_Evaluation}
